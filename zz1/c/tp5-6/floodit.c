...
void afficheFloodIt(unsigned long wpx, unsigned long bpx,int taille_t)
{
    ...
    /*Affichage O*/
    XSetForeground(dpy, gcontext, val_pixels[2]);
    ...
    /*Affichage O2*/
    XSetForeground(dpy, gcontext, val_pixels[3]);
    ...
    /*Affichage d*/
    XSetForeground(dpy, gcontext, val_pixels[4]);
    ...
    /*Affichage i*/
    XSetForeground(dpy, gcontext, val_pixels[5]);
    ...
    /*Affichage t*/
    XSetForeground(dpy, gcontext, val_pixels[6]);
